...
class WirausahaController extends Controller
{
    public function index(Request $request)
    {
        if($request->cari != '') {
            ...
            ->select('wirausahas.id','wirausahas.nama','wirausahas.alamat_lengkap','wirausahas.lokasi','kategori_perusahaans.nama as nama_kategori','wirausahas.user_id','users.name as nama_pemilik','kotas.tipe','kotas.nama_kota','provinsis.nama_provinsi')
    ...
    public function wirausaha(Request $request) // wirausaha per profile
    {
        ...
        $data = DB::table('wirausahas')
        ->select('wirausahas.id','wirausahas.nama','wirausahas.alamat_lengkap','wirausahas.lokasi','kategori_perusahaans.nama as nama_kategori','wirausahas.user_id','kotas.tipe','kotas.nama_kota','provinsis.nama_provinsi')
        ->join('users', 'wirausahas.user_id', '=', 'users.id')
        ->join('kotas', 'wirausahas.alamat_id', '=', 'kotas.id')
        ->join('provinsis', 'kotas.provinsi_id', '=', 'provinsis.id')
        ->join('kategori_perusahaans', 'wirausahas.kategori_id', '=', 'kategori_perusahaans.id')
