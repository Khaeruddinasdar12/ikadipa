  ...
  public function login(Request $request)
  {
    ...
    // UBAH DATA PRIBADI
      if($request->nama || $request->nohp || $request->alamat_id || $request->alamat_lengkap) {
        ...
        $data->alamat     = $request->alamat_lengkap;
        $data->alamat_id  = $request->alamat_id;
        $pesan = 'Berhasil mengubah data pribadi';
      }
...
// UBAH PEKERJAAN
    if($request->perusahaan && $request->jabatan && $request->kategori_perusahaan_id && $request->alamat_perusahaan) {
      $validator = Validator::make($request->all(), [
        'kategori_perusahaan_id' => 'numeric',
        'perusahaan'    => 'string',
        'jabatan'   => 'string',
      ...
      $data->jabatan = $request->jabatan;
      $data->alamat_perusahaan = $request->alamat_perusahaan;
      $pesan = 'Berhasil mengubah data pekerjaan';
    }
