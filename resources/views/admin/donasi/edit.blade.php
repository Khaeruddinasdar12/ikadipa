...
@section('title') Edit Donasi @endsection
		...
		<div class="row">
			...
			<div class="col-12">
				...
				<div class="card card-secondary card-outline">
					<form method="post" enctype="multipart/form-data" action="{{route('donasi.update', ['id' => $data->id])}}">
						<div class="card-header">
							<h2 class="card-title"><i class="fa fa-hand-holding-usd"></i> Edit Donasi</h2>
							...
							<div class="row">
								<div class="col-12">
									...
									<div class="form-group">
										<input type="text" class="form-control" placeholder="masukkan judul donasi" name="judul" value="{{old('judul', $data->nama)}}">
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-6">
									...
									<div class="form-group">
										<input type="date" name="date_end" min="<?php echo date('Y-m-d'); ?>" class="form-control" value="{{old('date_end', $data->date_end)}}">
									</div>
								</div>
							</div>
							<textarea id="summernote" name="isi">
								{{old('isi', $data->deskripsi)}}
							</textarea>
						</div>
					</form>
				</div>
