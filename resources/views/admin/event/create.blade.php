...
@section('title') Tambah Event @endsection
		...
		<div class="row">
			...
			<div class="col-12">
				...
				<div class="alert alert-success alert-dismissible fade show" role="alert">
					<strong>Berhasil Menambah Event !</strong> <a href="{{route('event.edit', session('success'))}}" class="alert-anchor">sunting</a>
				...
				<div class="card card-secondary card-outline">
					<form method="post" enctype="multipart/form-data" action="{{route('event.post')}}">
						<div class="card-header">
							<h2 class="card-title"><i class="fa fa-calendar-plus"></i> Tambah Event</h2>
							...
							<div class="row">
								<div class="col-6">
									...
									<div class="form-group">
										<input type="text" class="form-control" placeholder="masukkan nama event" name="nama" value="{{old('nama')}}">
									</div>
								</div>
								<div class="col-6">
									<label>Lokasi Event</label>
									<div class="form-group">
										<input type="text" class="form-control" placeholder="masukkan lokasi event" name="lokasi" value="{{old('lokasi')}}">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-6">
									<div class="row">
										<div class="col-6">
											...
											<div class="form-group">
												<input type="date" class="form-control" name="date_start" min="<?php echo date('Y-m-d'); ?>" value="{{old('date_start')}}" id="date_start" onchange="cekTanggalMulai()">
											</div>
										</div>
										<div class="col-6">
											<label>Tanggal Berakhir</label>
											<div class="form-group">
												<input type="date" class="form-control" name="date_end" min="<?php echo date('Y-m-d'); ?>" value="{{old('date_end')}}" id="date_end" onchange="cekTanggal()">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-6">
									<div class="row">
										<div class="col-6">
											...
											<div class="form-group">
												<input type="text" class="form-control" name="time_start" placeholder="ex. 08:30 WITA" value="{{old('time_start')}}">
											</div>
										</div>
										<div class="col-6">
											<label>Waktu Berakhir</label>
											<div class="form-group">
												<input type="text" class="form-control" name="time_end" placeholder="ex. 09:30 WITA" value="{{old('time_end')}}">
											</div>
										</div>
									</div>
								</div>
