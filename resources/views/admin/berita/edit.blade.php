...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark"><i class="fa fa-newspaper"></i> Edit Berita</h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
		...
		<div class="row">
			...
			<div class="col-12">
				...
				<div class="alert alert-success alert-dismissible fade show" role="alert">
					<strong>Berhasil Mengubah Berita !</strong> <a href="{{route('berita.edit', session('success'))}}" class="alert-anchor">Sunting</a> atau <a href="{{route('berita.show', session('success'))}}" class="alert-anchor">Preview</a>
				...
				<div class="card card-secondary card-outline">
					<form method="post" enctype="multipart/form-data" action="{{route('berita.update', ['id' => $data->id])}}">
						<div class="card-header">
							<h2 class="card-title"><i class="fa fa-newspaper"></i> Edit Berita</h2>
						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-6">
									...
									<div class="form-group">
										@php $kategori = preg_split ("/\,/", $data->kategori);  @endphp

										@foreach($ktg as $ktgr)
										<div class="form-check">
											<input class="form-check-input" type="checkbox" name="kategori[]" value="{{$ktgr->id}}" @if(in_array($ktgr->id, $kategori)) checked @endif>
